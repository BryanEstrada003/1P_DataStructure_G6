...
public class MainTest {
    public static void main(String args[]){
        ...
        DoublyLinkedList<Image> photos = new DoublyLinkedList<>();
        ...
        datesInterest.add(new Date("cumpleaños", otroDia));
        ...
        relatedContacts.add(new RelatedContact("Amigo", otro1));
        relatedContacts.add(new RelatedContact("Empresa", otro2));
