...
// Apply styling to the label
                    fin.setText(s);
                    fin.setFont(Font.font("Arial", FontWeight.BOLD, 20)); // Bold for emphasis
                    fin.setTextFill(Color.web("#007AFF")); // Cool blue color
                    fin.setAlignment(Pos.CENTER); // Center the text both horizontally and vertically
                    fin.setWrapText(true);  // Enable text wrapping

// Add the label to the containers (no animation code added)
                    labels_partidos.getChildren().add(fin);
